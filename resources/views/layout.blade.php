...
<body>
<div id="telescope" v-cloak class="h-full">
    ...
    <div class="container h-full mb-5">
        <div class="d-flex flex-column" v-bind:class="{'h-full':isFullPageLayout}">
            <div class="d-flex align-items-stretch py-4 header">
                ...
                <span class="ml-2" v-if="hasApplications && isAuthenticated">
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button" aria-expanded="false" @click="states.ddOpen = !states.ddOpen">
                            <span v-html="currentApplication"></span>
                        </button>
                        <ul class="dropdown-menu" v-bind:class="{'show':states.ddOpen}">
                            <li v-for="(name, uuid) in applications">
                                <button class="dropdown-item" type="button" v-html="name" @click="selectApp(uuid)"></button>
                            </li>
                        </ul>
                    </div>
                </span>

                <button v-if="isAuthenticated" class="btn btn-muted ml-auto mr-3 d-flex align-items-center py-2" v-on:click.prevent="toggleRecording" :title="recording ? 'Pause recording' : 'Resume recording'">
                ...
                <button v-if="isAuthenticated" class="btn btn-muted mr-3 d-flex align-items-center py-2" v-on:click.prevent="clearEntries" title="Clear entries">
                ...
                <button v-if="isAuthenticated" class="btn btn-muted mr-3 d-flex align-items-center py-2" :class="{active: autoLoadsNewEntries}" v-on:click.prevent="autoLoadNewEntries" title="Auto load entries">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon" fill="currentColor">
                        <path fill-rule="evenodd" d="M15.312 11.424a5.5 5.5 0 01-9.201 2.466l-.312-.311h2.433a.75.75 0 000-1.5H3.989a.75.75 0 00-.75.75v4.242a.75.75 0 001.5 0v-2.43l.31.31a7 7 0 0011.712-3.138.75.75 0 00-1.449-.39zm1.23-3.723a.75.75 0 00.219-.53V2.929a.75.75 0 00-1.5 0V5.36l-.31-.31A7 7 0 003.239 8.188a.75.75 0 101.448.389A5.5 5.5 0 0113.89 6.11l.311.31h-2.432a.75.75 0 000 1.5h4.243a.75.75 0 00.53-.219z" clip-rule="evenodd" />
                    </svg>
                </button>

                <router-link v-if="isAuthenticated" to="/monitored-tags" class="btn btn-muted mr-3 d-flex align-items-center py-2" title="Monitoring">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon" fill="currentColor">
                ...
                <router-link v-if="isAuthenticated" to="/logout" class="btn btn-muted d-flex align-items-center py-2" title="Logout">
                    <svg width="20px" height="20px" viewBox="-6 -6 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                                ...
                                <g id="Icon-Set" sketch:type="MSLayerGroup"
                                    transform="translate(-568.000000, -1087.000000)" fill="#000000">
                                    <path
            ...
            <div class="flex-grow-1 d-flex justify-content-center" v-if="!isAuthenticated">
                <router-view class="align-self-center"></router-view>
            </div>
        </div>
    </div>
</div>
