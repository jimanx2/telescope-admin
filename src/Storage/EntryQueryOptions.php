...
{
    /**
     * The application uuid that entries should belong to.
     *
     * @var string
     */
    ...
    {
        return (new static)
                ->applicationUuid($request->application_uuid)
     ...
     * @return $this
     */
    public function applicationUuid(?string $uuid)
    {
    ...
    /**
     * Set the application Uuid for the query.
     *
     * @param  string  $batchId
     * @return $this
     */
