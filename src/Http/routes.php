...
if ( config('telescope.domain') !== false) {

// Session entries...
Route::get('/telescope-api/applications', 'SessionController@applications');
Route::get('/telescope-api/session', 'SessionController@me');
Route::post('/telescope-api/session', 'SessionController@login');
Route::delete('/telescope-api/session', 'SessionController@logout');
